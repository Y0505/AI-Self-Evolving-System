...
function buildInstructions(
  ...
  return [
    ...
    'The git_push tool accepts an empty object; it pushes the currently checked-out local branch to the same branch on the fixed origin remote and always requires explicit approval.',
    "Git mutation tools must remain narrowly scoped; do not assume arbitrary Git commands are available.",
    "Higher-impact Git mutations such as reset and clean are not available.",
