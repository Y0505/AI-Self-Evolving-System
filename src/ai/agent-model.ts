...
function buildInstructions(
  ...
  return [
    ...
    "Available tools: read_file, write_file, remove_file, run_tests, git_status, git_diff, git_branches, git_create_branch, git_stage.",
    ...
    "Higher-impact Git mutations such as commit, reset, clean, and push are not available without an explicit approval boundary.",
